...
function Botao(){
    this.elemento = novoElemento('span','botao')
    this.novamente = botao =>{
    ...
    this.start = () => {
        ...
        const temporizador = setInterval(() => {
            ...
            if(Colisao(passaro, barreiras)){
                ...
                document.getElementById('botao').innerText=`Você fez ${pontuacao} pontos\nJogar Novamente?`
            }
        }, 20)
    }
...
iniciar.addEventListener('click', ()=>{
    ...
    document.getElementById('botaoini').style.display='none'
})
